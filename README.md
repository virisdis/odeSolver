Небольшой проект на C++, в духе boost.odeint реализующий численное интегрирование систем обыкновенных дифференциальных уравнений (ОДУ, ODE). Реализацию, вероятно, можно назвать модульной.
